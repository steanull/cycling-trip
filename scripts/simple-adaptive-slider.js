...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var slider = new SimpleAdaptiveSlider('.bicycles__slider', {
    loop: false,
    autoplay: false,
    interval: 5000,
    swipe: true,
...
var WRAPPER_SELECTOR = '.bicycles__slider-wrapper';
var ITEMS_SELECTOR = '.bicycles__card';
var ITEM_SELECTOR = '.bicycles__item';
var ITEM_CLASS_ACTIVE = 'bicycles__item_active';
var CONTROL_SELECTOR = '.slider__control';
var CONTROL_CLASS_SHOW = 'slider__control_show';
// индикаторы
var INDICATOR_WRAPPER_ELEMENT = 'ol';
var INDICATOR_WRAPPER_CLASS = 'bicycles__indicators';
var INDICATOR_ITEM_ELEMENT = 'li';
var INDICATOR_ITEM_CLASS = 'bicycles__indicator';
var INDICATOR_ITEM_CLASS_ACTIVE = 'bicycles__indicator_active';
...
function SimpleAdaptiveSlider(selector, config) {
  // .slider
  this._$root = selector instanceof Element ? selector : document.querySelector(selector);
  // .slider__wrapper
